...
class ToolbarDropdown extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            examplesItems: [{ label: "Example Models" }],
            helpItems: [{ label: "Help..." }, { label: "Help on Antimony" }, { label: "About Iridium" }],
        };
    }
        ...
        return (
            <div className="top-menu">
                ...
                <div className={"container-of-toolbar-and-dropdown"}>
                    <button className="top-menu-button" onClick={() => this.handleToolbarButtons("File")}>
                        File
                    </button>
                    {this.renderDropdownForButton(
                        "File",
                        fileItems,
                        "dropdown-file-container",
                        "dropdown-toolbar-button-file",
                    )}
                </div>
